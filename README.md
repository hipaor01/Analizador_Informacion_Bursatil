...
python main.py --accion [Accion] --indice [Indice] --api [API]. 
Ejemplos de uso serían python main.py --accion Apple --api yfinance o python main.py --indice Nasdaq --api yfinance. Importante en el caso de nombres con el carácter & pasarlos entrecomillados, python main.py --accion "Johnson & Johnson" --api yfinance.
